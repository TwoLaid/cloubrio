...
(function () {
  ...
  var stickyNav = document.querySelector('nav.navigation');
  var navElements = document.querySelectorAll('nav.navigation .nav-item a');
...
function onYouTubeIframeAPIReady() {
  ...
  if (landingVideo) {
    var video = landingVideo.querySelector('video');
